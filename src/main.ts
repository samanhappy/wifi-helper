...
const messages: Record<Locale, LocaleMessages> = {
  ...
  en: {
    ...
    heroCopy:
      "Detect when your Mac is connected to Wi‑Fi but cannot reach the internet, and open the captive portal login page in your default browser when needed.",
    ...
    statusSummaries: {
      ...
      notOnWifi: "You are not currently connected to Wi‑Fi, so no portal will be opened.",
